        ...
        <div className= "md:flex justify-end items-center hidden">
            ...
            <FaXTwitter className='text-xl'/>
            {
                ...
                {  dropDown &&
                    ...
                    <button className='px-4 py-2 text-sm text-gray-700 flex items-center gap-2'><FaPowerOff/>Logout</button>
                </div>}
                </div>
            }
        ...
        <div className="flex justify-between items-center text-2xl md:hidden">
            ...
            {/* login link */}
            {
                ...
                {  dropDown &&
                    ...
                    <button className='px-4 py-2 text-sm text-gray-700 flex items-center'><FaPowerOff/>Logout</button>
                </div>}
                </div>
            }
        </div>
